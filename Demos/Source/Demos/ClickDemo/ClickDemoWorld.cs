...
internal class ClickDemoWorld : DemoWorld
{
    ...
    {
        Add(new Button(75, 75, 150, 150, ButtonTheme.FromColour(Colour.Orange)));
        Add(new Button(50, 50, 100, 100, ButtonTheme.FromColour(Colour.Green)));
        Add(new Button(100, 100, 100, 100, ButtonTheme.FromColour(Colour.Fuchsia)));
