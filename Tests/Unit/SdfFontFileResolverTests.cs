...
[TestClass]
public class SdfFontFileResolverTests
{
    ...
    {
        string path = SdfFontFileResolver.Resolve("Arial");
    ...
    {
        string path = SdfFontFileResolver.Resolve("Times New Roman");
    ...
    {
        Assert.ThrowsExactly<FileNotFoundException>(() => SdfFontFileResolver.Resolve("ThisFontDoesNotExist_xyz"));
    }
}
