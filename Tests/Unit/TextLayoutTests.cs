...
public class TextLayoutTests
{
    ...
    private static FontAtlasMetrics MakeMetrics(string charsNeeded, int charWidth = 10, int charHeight = 20)
    {
        ...
        return new FontAtlasMetrics(charWidth, charHeight, positions, normPositions);
    }
    ...
    {
        FontAtlasMetrics fs = MakeMetrics("a");
    ...
    public void ComputeLines_TwoWordsThatDontFit_BreakAtSpace()
    {
        ...
        FontAtlasMetrics fs = MakeMetrics("hello world");
    ...
    public void ComputeLines_WordLongerThanWidth_CharacterWraps()
    {
        ...
        FontAtlasMetrics fs = MakeMetrics("toolngwrd");
    ...
    public void ComputeLines_LongWordThenShortWords_CharWrapsThenWordWraps()
    {
        ...
        FontAtlasMetrics fs = MakeMetrics("toolngwrd a e m ");
    ...
    public void ComputeLines_ScaleXDoubled_HalvesEffectiveMaxWidth()
    {
        ...
        // So: "hel"|"lo" for "hello"
        FontAtlasMetrics fs = MakeMetrics("helo");
    ...
    public void ComputeLines_ExtraSpaceWidth_AffectsWrapPoint()
    {
        ...
        FontAtlasMetrics fs = MakeMetrics("ab cd");
    ...
    public void MeasureLine_WithExtraSpaceWidth_AddsToSpacesOnly()
    {
        ...
        FontAtlasMetrics fs = MakeMetrics("hi ");
    ...
    public void MeasureLine_StringWithSpace_SpaceUsesExtraSpaceWidthNotExtraCharSpacing()
    {
        ...
        FontAtlasMetrics fs = MakeMetrics("a b");
